...
const LoginForm = ({ formik, authError, t }) => (
      ...
      <Form.Floating className="mb-3">
        <Form.Control
          ...
          className={`form-control ${
            formik.touched.username && (authError || formik.errors.username)
              ? 'is-invalid'
              : ''
          }`}
    ...
    <Form.Group controlId="password">
      <Form.Floating className="mb-3">
        <Form.Control
          ...
          type="password"
          className={`form-control ${
            formik.touched.password && (authError || formik.errors.password)
              ? 'is-invalid'
              : ''
          }`}
...
const LoginPage = () => {
  ...
  const validate = getValidationSchema(t);
        ...
        <Row className="w-50">
          <Col className=" border rounded .mx-auto mb-5 shadow">
            <div style={{ padding: '15px' }}>
              ...
              <LoginForm formik={formik} authError={authError} t={t} />
            </div>
            <LoginFooter t={t} />
          </Col>
        </Row>
